            ...
            if($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    echo "<tr>
                        ...
                        echo "<td>
                            <a href='update_place.php?id=".$row['placeID']."'><button class='btn btn-success' type='button'>Edit</button></a>
                            <a href='delete_location.php?id=".$row['placeID']."'><button class='btn btn-danger' type='button'>Delete</button></a>
                        </td>
                    </tr>";}
                }
            } else {
